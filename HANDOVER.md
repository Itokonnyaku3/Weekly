...
最終更新: 2026-05-30 / 担当バージョン: v1.8.0-05301450-gridwk
...
- **追加課題（コピペ/複数選択の同等化）**: 監査完了。中核は「システムクリップボード＋複数MIME＋独自マーカー`data-pwt-clip`」方式への作り替え（現行の内部完全一致が脆い）。Phase1堅牢化→P2リッチ(HTML)→P3表→P4画像の順で合意。画像はGitHub必須維持。**仕様書: `仕様書_コピペ貼付機能.md`**。実装は未着手（ユーザーのレビュー後）。
